...
router.post('/test', fquestions, fchoices, (req, res) => {
    ...
    if(!req.body.choice1 || !req.body.choice2 || !req.body.choice3 || !req.body.choice4 || !req.body.choice5 || !req.body.choice6 || !req.body.choice7 || !req.body.choice8 || !req.body.choice9 || !req.body.choice10 ){
      ...
      testOn = 0;
      db.query("INSERT INTO tbluser (strSNum, strName, strEmail, txtContact, strPassword, strStatus, intCommend, intReport, strType, boolLoggedin) VALUES (?,?,?,?,?,?,?,?,'unregistered','0','0','normal','0')",[tempRegister.studnum,tempRegister.studname,tempRegister.email,tempRegister.contact,tempRegister.password], (err, results, fields) => {
          if (err) console.log(err);
          for(count=0;count<10;count++){
