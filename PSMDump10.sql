...
CREATE TABLE `tblitem` (
  ...
  `strItemTitle` tinytext NOT NULL,
...
INSERT INTO `tblquestions` VALUES (1,'Where is the Obelisk located at?',0),(2,'How many wings does the main building have?',0),(3,'Who is the national hero that has a \"tahanan\" in our Sintang Paaralan?',0),(4,'Who is Ted Pylon?',1),(5,'Where is the UFO/Watertank located at in PUP?',1),(6,'The favorite mall of students when there are no professors',1),(7,'What does \"FEWA\" mean?',0),(8,'How many basketball courts does PUP Sta. Mesa have?',0),(9,'How many 7/11 branches are there near PUP Sta. Mesa?',0),(10,'What is the first name of PUP?',0),(11,'What year did PUP officially become a university?',1),(12,'What would you do if there is a shortage of chairs in your room?',1),(13,'Who is the \"Einstein\" of PUP Sta. Mesa?',1),(14,'Who is the current president of PUP?',1),(15,'How many characters does the student number have (excluding dashes)?',1),(16,'What is the real name of the event \"Kikiam run\"?',1),(17,'How many floors does the PUP main building have?',0),(18,'What does \"Virgin\" sell?',0),(19,'Currently, what does \"Intramuros\" behold inside?',0),(20,'Other than the FEWA, what is the other famous food from PUP?',0),(21,'Where is the most presentable comfort room located at in PUP Sta. Mesa?',0),(22,'How long do you have to wait until you could safely assume that your professor is absent?',0),(23,'What is the latest end of classes in PUP?',1),(24,'When you were a freshie, how long did the line go during registration?',0);
